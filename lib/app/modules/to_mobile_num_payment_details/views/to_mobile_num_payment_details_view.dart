...
class ToMobileNumPaymentDetailsView extends GetView<ToMobileNumPaymentDetailsController> {
  // Define a variable to store the contact name
  final String contactName;
  final Uint8List? contactImage;
  // Constructor to receive the contact name as an argument
  const ToMobileNumPaymentDetailsView({super.key, required this.contactName,  this.contactImage});
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              CircleAvatar(
                radius: 25,
                backgroundImage: contactImage != null ? MemoryImage(contactImage!) : null,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Row(
                        ...
                        // Ensures tight wrapping of children
                        children: [
                          Flexible(
                            child: Text(
                              '$contactName',
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: TextField(
                                    ...
                                    onChanged: (value) {
                                      controller.hasInteractedWithAmount.value =
                                      true;
                        ...
                        Obx(() {
                          return Visibility(
                            visible: !controller.isAmountValid.value &&
                                controller.hasInteractedWithAmount.value,
                            // Show validation if user interacted
                            child: Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (controller.amountController.text.isEmpty) {
                            ...
                            false; // Show validation if empty
                          } else {
                            controller.isAmountValid.value = true;
                            ...
                            showModalBottomSheet(
                              ...
                              builder: (context) {
                                ...
                                return DraggableScrollableSheet(
                                  ...
                                  // Half of the screen size initially
                                  minChildSize: 0.5,
                                  // Minimum size (30% of the screen)
                                  maxChildSize: 0.5,
                                  // Maximum size (80% of the screen for better visibility)
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Obx(() {
                                                final formattedTotalPayable = NumberFormat(
                                                    '#,##0.00').format(
                                          ...
                                          Expanded(
                                            child: ListView.builder(
                                              ...
                                              // Use the provided scrollController for DraggableScrollableSheet
                                              itemCount: controller.banks
                                                  .length + 1,
                                              // Add 1 for the "Add bank" option
                                          ...
                                          Container(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                if (controller.amountController
                                                    .text.isEmpty) {
  ...
  String getInitials(String name) {
    ...
    return initials.isNotEmpty
        ? initials
        : 'N/A'; // Return N/A if no initials are found
  }
