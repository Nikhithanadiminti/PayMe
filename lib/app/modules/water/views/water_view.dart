      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Obx(()=>
             TextFormField(
              onChanged: (value){
                waterController.searchWaterBillers(value);
              },
               controller: waterController.searchWaterBillerCon.value,
        ...
        child: Padding(
          ...
          child: Image.asset(
            ...
            fit: BoxFit.fill,
              ...
              Obx(()=>
              waterController.searchWaterBillerCon.value.text.isNotEmpty
                  ? const SizedBox()
                  : _buildBillersSection("Billers in Telangana",waterController.filterBillersList),
              ),
              const SizedBox(height: 25),
              _buildBillersSection("All Billers",waterController.filterBillersList),
            ],
          ),
        ),
      ),
        ...
        children: [
         ...
         // isList ?
          ListView.separated(
            ...
            itemCount: title == "Billers in Telangana" && waterController.searchWaterBillerCon.value.text.isEmpty
                ? 2
                : billers.length,
    ...
    return Scaffold(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Form(
                  key: waterController.billerDetailsFormKey,
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            if(!waterController.billerDetailsFormKey.currentState!.validate()){
